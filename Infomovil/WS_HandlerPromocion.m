...
//    NSString *rutaImagenPromocion = [dictOferta objectForKey:@"rutaImagen"];
//	
//	NSString *endDate;
//    if ([dictOferta objectForKey:@"fechaSeleccionada"] != nil) {
//        NSDateFormatter* formatter = [[NSDateFormatter alloc] init];
//        [formatter setDateFormat:@"dd/MM/YYYY"];
//        endDate = [formatter stringFromDate:[dictOferta objectForKey:@"fechaSeleccionada"]];
//    }
...
//                     [StringUtils encriptar:[NSString stringWithFormat:@"%i", idDominio] conToken:tokenEncript],
//                     [StringUtils encriptar:[dictOferta objectForKey:@"descripcionPromocion"] conToken:tokenEncript],
//                     [StringUtils encriptar:endDate conToken:tokenEncript]];
//        
//        
...
//         "</soapenv:Body>"
//         "</soapenv:Envelope>",
//         [StringUtils encriptar:[dictOferta objectForKey:@"redencion"] conToken:tokenEncript],
//         [StringUtils encriptar:[dictOferta objectForKey:@"informacionPromocion"] conToken:tokenEncript],
//         [StringUtils encriptar:[dictOferta objectForKey:@"tituloPromocion"] conToken:tokenEncript],
//         [StringUtils encriptar:emailUsuario conToken:passwordEncriptar]];
////    }
////    else {
////        stringXML = [NSMutableString stringWithFormat:@"<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ws=\"http://ws.webservice.infomovil.org/\">"
////                     "<soapenv:Header/>"
...
////                     "<OffertRecordVO>"
////                     "<descOffer>%@</descOffer>"
////                     "<endDateOffer>%@</endDateOffer>" , idDominio, [dictOferta objectForKey:@"descripcionPromocion"], endDate];
////        
////        
...
////         "</ws:updateinsertOfferRecord>"
////         "</soapenv:Body>"
////         "</soapenv:Envelope>", [dictOferta objectForKey:@"redencion"], [dictOferta objectForKey:@"informacionPromocion"], [dictOferta objectForKey:@"tituloPromocion"]];
////    }
//    
...
////                tokenEncript = self.token;
//                [self.promocionDelegate resultadoConsultaDominio:[StringUtils desEncriptar:_resultado conToken:_token]];
////            }
////            else {
////                [self.promocionDelegate resultadoConsultaDominio:self.resultado];
////            }
//            
//        }
//        else {
