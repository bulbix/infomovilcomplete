    ...
    if (self.checkingForNewVersion)
    {
        ...
        if (details)
        {
            ...
            if (showDetails && !self.visibleRemoteAlert)
            {
                ...
                BOOL showIgnoreButton = NO;//[self.ignoreButtonLabel length] && self.updatePriority < iVersionUpdatePriorityMedium;
                BOOL showRemindButton = NO;//[self.remindButtonLabel length] && self.updatePriority < iVersionUpdatePriorityHigh;
